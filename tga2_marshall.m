% TGA simulation for Marshalls live doug-fir foliage TG-FTIR tests
...
m0(1,:) = (24.092)/MW(1); % CELL 
m0(17,:) = (15.6317)/MW(17); % HCE
m0(24,:) = (13.672/3)/MW(24); % LIGH
m0(25,:) = (13.672/3)/MW(25); % LIGO
m0(23,:) = (13.672/3)/MW(23); % LIGC
m0(38,:) = (2.3269)/MW(38); % TGL
m0(37,:) = (0.3384)/MW(37); % TANN
m0(39,:) = (8)/MW(39); % moisture

%% initialize mass calcs 

mass0 = m0.*MW; % kg
% yi0 = mass0(s_index,1)./100;
rhos_mass0 = rhos_mass0+100; %+492
