...
% save ox_new_rxnorder_withe.mat yy ye mass Ts yy1

toc; 

% ODE function y2' species xport
...
%         % char oxidation reactions RC4 & 5
%         % A4 = 1.2e7;
%         A4 = 1.2e13; 
%         Ea4 = 4.184*32300;
%         % A5 = 5.7e7; % [mol^-1.m^3.s^-1]
%         A5 = 5.7e12; 
%         Ea5 = 38200*4.184; % [J/mol]
% 
%         r5 = A5*exp(-Ea5/R/T(i))*m(15,i)*(m(48,i)/Mesh.dv/phi(i))^0.78; %[mol/s]
%         r4 = A4*exp(-Ea4/R/T(i))*m(15,i)*m(48,i)/Mesh.dv/phi(i); 
% 
