...
sample_height = 2.3596e-3; % [m]
sample_radius = sample_height/2; % [m]
Mesh.dz = sample_height/(Mesh.Jnodes);
%pie = pi;
Mesh.a = 0.04*sample_height; % 2*pie*sample_radius*(.04+sample_radius); % surface area, [m2]
