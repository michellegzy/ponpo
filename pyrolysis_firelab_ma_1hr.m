%% pyrolysis for Fire Lab - MA 1hr wood (OR grape)
tic
...
qs = 45000; % input heat flux [w/m2] --> ~double
y0 = [rhogphi0(:); rgpy0(:)]; 
...
dt = .1;
nstep = 410; % course mesh during testing
time = 0;
t = zeros(nstep+1,1); 
